...
def get_student_information(id_number, cookie):
    """查询学员的报名信息"""
    url = 'http://223.4.72.243:8011/sxjgpt/student.do?list'
    headers = {
        ...
        'Cookie': cookie,
        'Host': '223.4.72.243:8011',
        'Origin': 'http://223.4.72.243:8011',
        'Referer': 'http://223.4.72.243:8011/sxjgpt/student.do?main&menuId=402881e45aa6c5ae015aa6ca05cc0001',
...
def get_training_record(id_number, cookie):
    """查询学员的阶段报审信息推送公安的情况"""
    url = 'http://223.4.72.243:8011/sxjgpt/sendPolice.do?list'
    headers = {
        'Accept': 'application/json, text/javascript, */*; q=0.01',
        'Accept-Encoding': 'gzip, deflate',
        'Accept-Language': 'zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6',
        ...
        'Host': '223.4.72.243:8011',
        'Origin': 'http://223.4.72.243:8011',
        'Referer': 'http://223.4.72.243:8011/sxjgpt/sendPolice.do?main&menuId=297e33aa5d588f04015d5891a99a0002',
        'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36 Edg/91.0.864.67',
        'X-Requested-With': 'XMLHttpRequest',
    }
    data = {
...
start = time()  # 程序开始计时
cookie = 'JSESSIONID=20E6F6DF6E6AF31EE6E1FF8B8703ECE3'
file_name = '二次变更考试地（7.2-7.14）.xls'
output(file_name)
end = time()  # 程序计时结束
